...
<video autoplay muted loop id="myVideo">
    <source src="ocean-148565.mp4" type="video/mp4">
  </video>
  ...
  <div class="content">
   ...
   <input type="number" id="in"  name="num"   placeholder="Mobile number" required  oninvalid="this.setCustomValidity('please give your mobile number')" 
   onchange="this.setCustomValidity('')" ><br><br>
